...
* **Digital Debounce Filter:** Button nodes are equipped with an adaptive delay function when a `LOW` input is detected to filter out mechanical switch bouncing noise common in industrial environments.
